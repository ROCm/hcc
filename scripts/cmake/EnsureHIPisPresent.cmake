  ...
  if(EXISTS "${HIP_HEADER_DIR}/hip_runtime.h")
    ...
    if(${USE_LOCAL_HIP})
      ...
      create_link("${LOCAL_HIP_DIR}/hip_runtime.cpp" "${HIP_LIB_DIR}")
        ...
        execute_process(COMMAND mkdir "${HIP_HEADER_DIR}/hcc_detail"
                        WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})
      ...
      create_link("${REMOTE_HIP_DIR}/include/hcc_detail/hip_runtime_api.h" "${HIP_HEADER_DIR}/hcc_detail")
      create_link("${REMOTE_HIP_DIR}/include/hcc_detail/hip_runtime.h" "${HIP_HEADER_DIR}/hcc_detail")
      create_link("${REMOTE_HIP_DIR}/include/hcc_detail/hip_texture.h" "${HIP_HEADER_DIR}/hcc_detail")
