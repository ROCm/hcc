...
bool test3D() {
  ...
  parallel_for_each(extent<3>(grid_size_0, grid_size_1, grid_size_2).tile<tile_size_0, tile_size_1, tile_size_2>(), [=](tiled_index<tile_size_0, tile_size_1, tile_size_2>& idx) restrict(amp) {
    av1(idx) = idx.global[0];
    av2(idx) = idx.global[1];
