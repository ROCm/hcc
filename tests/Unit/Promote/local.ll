...
;CHECK: ZZ4mainEN3_EC__019__cxxamp_trampolineEiiiiPiiiiiiiiii.ZZ4mainEN6localAE = {{.+}} addrspace(3) global [10 x [10 x i32]]
...
;CHECK:   %arrayidx3.i = getelementptr inbounds [10 x [10 x i32]] addrspace(3)* @ZZ4mainEN3_EC__019__cxxamp_trampolineEiiiiPiiiiiiiiii.ZZ4mainEN6localAE, i32 0,
...
for.cond4.preheader.i:                            ; preds = %for.cond4.preheader.i, %entry
  ...
  %14 = bitcast i32* %arrayidx8.i to i32 addrspace(3)*
  ...
  %15 = bitcast i32* %arrayidx8.1.i to i32 addrspace(3)*
  ...
  %16 = bitcast i32* %arrayidx8.2.i to i32 addrspace(3)*
  ...
  %17 = bitcast i32* %arrayidx8.3.i to i32 addrspace(3)*
  ...
  %18 = bitcast i32* %arrayidx8.4.i to i32 addrspace(3)*
  ...
  %19 = bitcast i32* %arrayidx8.5.i to i32 addrspace(3)*
  ...
  %20 = bitcast i32* %arrayidx8.6.i to i32 addrspace(3)*
  ...
  %21 = bitcast i32* %arrayidx8.7.i to i32 addrspace(3)*
  ...
  %22 = bitcast i32* %arrayidx8.8.i to i32 addrspace(3)*
  ...
  %23 = bitcast i32* %arrayidx8.9.i to i32 addrspace(3)*
