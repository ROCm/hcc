...
;CHECK: atomicnoret_add_global_rlx_system_s32 {{.*}}

  %add2 = atomicrmw add i32* %0, i32 %1 acquire
;CHECK: atomicnoret_add_global_scacq_system_s32 {{.*}}

  %add3 = atomicrmw add i32* %0, i32 %1 release
;CHECK: atomicnoret_add_global_screl_system_s32 {{.*}}

  %add4 = atomicrmw add i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_add_global_scar_system_s32 {{.*}}
