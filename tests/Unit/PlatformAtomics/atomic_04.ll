...
;CHECK: atomic_exch_global_rlx_sys_equiv({{.*}})_b32 {{.*}}

  %xchg2 = atomicrmw xchg i32* %0, i32 %1 acquire
;CHECK: atomic_exch_global_scacq_sys_equiv({{.*}})_b32 {{.*}}

  %xchg3 = atomicrmw xchg i32* %0, i32 %1 release
;CHECK: atomic_exch_global_screl_sys_equiv({{.*}})_b32 {{.*}}

  %xchg4 = atomicrmw xchg i32* %0, i32 %1 acq_rel
;CHECK: atomic_exch_global_scar_sys_equiv({{.*}})_b32 {{.*}}
