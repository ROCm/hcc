...
;CHECK: atomicnoret_cas_global_rlx_sys_equiv({{.*}}_b32 {{.*}}

  %cmpxchg2 = cmpxchg i32* %0, i32 %1, i32 2 acquire 
;CHECK: atomicnoret_cas_global_scacq_sys_equiv({{.*}}_b32 {{.*}}

  %cmpxchg3 = cmpxchg i32* %0, i32 %1, i32 2 release 
;CHECK: atomicnoret_cas_global_screl_sys_equiv({{.*}}_b32 {{.*}}

  %cmpxchg4 = cmpxchg i32* %0, i32 %1, i32 2 acq_rel 
;CHECK: atomicnoret_cas_global_scar_sys_equiv({{.*}}_b32 {{.*}}
