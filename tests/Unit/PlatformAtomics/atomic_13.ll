...
;CHECK: atomicnoret_max_global_rlx_sys_equiv({{.*}})_u32 {{.*}}

  %umax2 = atomicrmw umax i32* %0, i32 %1 acquire
;CHECK: atomicnoret_max_global_scacq_sys_equiv({{.*}})_u32 {{.*}}

  %umax3 = atomicrmw umax i32* %0, i32 %1 release
;CHECK: atomicnoret_max_global_screl_sys_equiv({{.*}})_u32 {{.*}}

  %umax4 = atomicrmw umax i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_max_global_scar_sys_equiv({{.*}})_u32 {{.*}}
