...
;CHECK: atomicnoret_xor_global_rlx_system_b32 {{.*}}

  %xor2 = atomicrmw xor i32* %0, i32 %1 acquire
;CHECK: atomicnoret_xor_global_scacq_system_b32 {{.*}}

  %xor3 = atomicrmw xor i32* %0, i32 %1 release
;CHECK: atomicnoret_xor_global_screl_system_b32 {{.*}}

  %xor4 = atomicrmw xor i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_xor_global_scar_system_b32 {{.*}}
