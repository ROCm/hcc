...
;CHECK: atomicnoret_min_global_rlx_sys_s32 {{.*}}

  %min2 = atomicrmw min i32* %0, i32 %1 acquire
;CHECK: atomicnoret_min_global_scacq_sys_s32 {{.*}}

  %min3 = atomicrmw min i32* %0, i32 %1 release
;CHECK: atomicnoret_min_global_screl_sys_s32 {{.*}}

  %min4 = atomicrmw min i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_min_global_scar_sys_s32 {{.*}}
