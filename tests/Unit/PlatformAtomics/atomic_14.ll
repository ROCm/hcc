...
;CHECK: atomicnoret_min_global_rlx_system_u32 {{.*}}

  %umin2 = atomicrmw umin i32* %0, i32 %1 acquire
;CHECK: atomicnoret_min_global_scacq_system_u32 {{.*}}

  %umin3 = atomicrmw umin i32* %0, i32 %1 release
;CHECK: atomicnoret_min_global_screl_system_u32 {{.*}}

  %umin4 = atomicrmw umin i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_min_global_scar_system_u32 {{.*}}
