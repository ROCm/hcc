...
;CHECK: atomicnoret_sub_global_rlx_system_s32 {{.*}}

  %sub2 = atomicrmw sub i32* %0, i32 %1 acquire
;CHECK: atomicnoret_sub_global_scacq_system_s32 {{.*}}

  %sub3 = atomicrmw sub i32* %0, i32 %1 release
;CHECK: atomicnoret_sub_global_screl_system_s32 {{.*}}

  %sub4 = atomicrmw sub i32* %0, i32 %1 acq_rel
;CHECK: atomicnoret_sub_global_scar_system_s32 {{.*}}
