...
test_fence:
  fence monotonic  ; fence can not be monotonic
  fence acquire    ; HSAIL backend does not support fence
  fence release    ; HSAIL backend does not support fence
  fence acq_rel    ; HSAIL backend does not support fence
  fence seq_cst    ; HSAIL backend does not support fence
