...
// define void @_Z3foo16grid_launch_parmii(i32{{.*}}, i32{{.*}}) [[HC:#[0-9]+]] {
// CHECK: define dso_local void @_Z3foo16grid_launch_parmii(i32{{.*}}, i32{{.*}}) [[HC:#[0-9]+]] {
// define i32 @_Z3barv() [[NHC:#[0-9]+]] {
// CHECK: define dso_local i32 @_Z3barv() [[NHC:#[0-9]+]] {
