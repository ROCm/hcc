// RUN: %hc -D_OBJ_1 %s -c -o %T/early_finalize_1.obj1.o -fno-gpu-rdc -fPIC
// RUN: %hc -D_OBJ_2 %s -c -o %T/early_finalize_1.obj2.o -fno-gpu-rdc -fPIC
// RUN: %hc -D_OBJ_3 %s -c -o %T/early_finalize_1.obj3.o -fno-gpu-rdc -fPIC
// RUN: %hc %T/early_finalize_1.obj1.o %T/early_finalize_1.obj2.o  %T/early_finalize_1.obj3.o -L %lib_output_path -Wl,-rpath=%lib_output_path -lmcwamp -o %t.out && %t.out
