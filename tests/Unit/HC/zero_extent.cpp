...
bool test1D() {
  ...
  // 1D non-tiled
  extent<1> ex1d(0);
  completion_future fut1 = parallel_for_each(ex1d, [&](index<1>& idx) __attribute((hc)) {
    table[idx[0]] = 1;
  });
  ...
  completion_future fut2 = parallel_for_each(tiled_ex1d, [&](tiled_index<1>& idx) __attribute((hc)) {
...
bool test2D() {
  ...
  // 2D non-tiled
  extent<2> ex2d(0, 0);
  completion_future fut1 = parallel_for_each(ex2d, [&](index<2>& idx) __attribute((hc)) {
  ...
  completion_future fut2 = parallel_for_each(tiled_ex2d, [&](tiled_index<2>& idx) __attribute((hc)) {
...
bool test3D() {
  ...
  // 3D non-tiled
  extent<3> ex3d(0, 0, 0);
  completion_future fut1 = parallel_for_each(ex3d, [&](index<3>& idx) __attribute((hc)) {
  ...
  completion_future fut2 = parallel_for_each(tiled_ex3d, [&](tiled_index<3>& idx) __attribute((hc)) {
