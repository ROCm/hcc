...
#pragma once
  ...
  extern "C" double opencl_acosh_double(double x) restrict(amp);

  extern "C" float opencl_asin(float x) restrict(amp);
  extern "C" double opencl_asin_double(double x) restrict(amp);

  extern "C" float opencl_asinh(float x) restrict(amp);
  extern "C" double opencl_asinh_double(double x) restrict(amp);

  extern "C" float opencl_atan(float x) restrict(amp);
  extern "C" double opencl_atan_double(double x) restrict(amp);

  extern "C" float opencl_atanh(float x) restrict(amp);
  extern "C" double opencl_atanh_double(double x) restrict(amp);

  extern "C" float opencl_atan2(float x, float y) restrict(amp);
  extern "C" double opencl_atan2_double(double x, double y) restrict(amp);

  extern "C" float opencl_cbrt(float x) restrict(amp);
  extern "C" double opencl_cbrt_double(double x) restrict(amp);

  extern "C" float opencl_ceil(float x) restrict(amp);
  extern "C" double opencl_ceil_double(double x) restrict(amp);

  extern "C" float opencl_copysign(float x, float y) restrict(amp);
  extern "C" double opencl_copysign_double(double x, double y) restrict(amp);

  extern "C" float opencl_cos(float x) restrict(amp);
  extern "C" double opencl_cos_double(double x) restrict(amp);

  extern "C" float opencl_cosh(float x) restrict(amp);
  extern "C" double opencl_cosh_double(double x) restrict(amp);

  extern "C" float opencl_cospi(float x) restrict(amp);
  extern "C" double opencl_cospi_double(double x) restrict(amp);

  extern "C" float opencl_erf(float x) restrict(amp);
  extern "C" double opencl_erf_double(double x) restrict(amp);

  extern "C" float opencl_erfc(float x) restrict(amp);
  extern "C" double opencl_erfc_double(double x) restrict(amp);
  ...
  extern "C" double opencl_exp_double(double x) restrict(amp);

  extern "C" float opencl_exp10(float x) restrict(amp);
  extern "C" double opencl_exp10_double(double x) restrict(amp);

  extern "C" float opencl_exp2(float x) restrict(amp);
  extern "C" double opencl_exp2_double(double x) restrict(amp);
  ...
  extern "C" double opencl_floor_double(double x) restrict(amp);

  extern "C" float opencl_fma(float x, float y, float z) restrict(amp);
  extern "C" double opencl_fma_double(double x, double y, double z) restrict(amp);

  extern "C" float opencl_fmax(float x, float y) restrict(amp);
  extern "C" double opencl_fmax_double(double x, double y) restrict(amp);

  extern "C" float opencl_fmin(float x, float y) restrict(amp);
  extern "C" double opencl_fmin_double(double x, double y) restrict(amp);

  extern "C" float opencl_fmod(float x, float y) restrict(amp);
  extern "C" double opencl_fmod_double(double x, double y) restrict(amp);
  ...
  extern "C" double opencl_hypot_double(double x, double y) restrict(amp);

  extern "C" int opencl_ilogb(float x) restrict(amp);
  extern "C" int opencl_ilogb_double(double x) restrict(amp);

  extern "C" int opencl_isfinite(float x) restrict(amp);
  extern "C" int opencl_isfinite_double(double x) restrict(amp);
  ...
  extern "C" double opencl_ldexp_double(double x, int exp) restrict(amp);

  /* SPIR pass will deduce the address space of the pointer and emit correct
     call instruction */
  extern "C" float opencl_lgammaf(float x, int *exp) restrict(amp);
  ...
  extern "C" float opencl_nan(int tagp) restrict(amp);
  extern "C" double opencl_nan_double(int tagp) restrict(amp);

  extern "C" float opencl_nearbyint(float x) restrict(amp);
  extern "C" double opencl_nearbyint_double(double x) restrict(amp);

  extern "C" float opencl_nextafter(float x, float y) restrict(amp);
  extern "C" double opencl_nextafter_double(double x, double y) restrict(amp);

  extern "C" float opencl_pow(float x, float y) restrict(amp);
  extern "C" double opencl_pow_double(double x, double y) restrict(amp);

  extern "C" float opencl_remainder(float x, float y) restrict(amp);
  extern "C" double opencl_remainder_double(double x, double y) restrict(amp);

  /* SPIR pass will deduce the address space of the pointer and emit correct
     call instruction */
  extern "C" float opencl_remquof(float x, float y, int *quo) restrict(amp);
  extern "C" double opencl_remquo(double x, double y, int *quo) restrict(amp);

  extern "C" float opencl_round(float x) restrict(amp);
  extern "C" double opencl_round_double(double x) restrict(amp);

  extern "C" float opencl_rsqrt(float x) restrict(amp);
  extern "C" double opencl_rsqrt_double(double x) restrict(amp);

  extern "C" float opencl_sinpi(float x) restrict(amp);
  extern "C" double opencl_sinpi_double(double x) restrict(amp);

  extern "C" int   opencl_signbit(float x) restrict(amp);
  extern "C" int   opencl_signbit_double(double x) restrict(amp);

  extern "C" float opencl_sin(float x) restrict(amp);
  extern "C" double opencl_sin_double(double x) restrict(amp);

  /* SPIR pass will deduce the address space of the pointer and emit correct
     call instruction */
  extern "C" void opencl_sincosf(float x, float *s, float *c) restrict(amp);
  extern "C" void opencl_sincos(double x, double *s, double *c) restrict(amp);

  extern "C" float opencl_sinh(float x) restrict(amp);
  extern "C" double opencl_sinh_double(double x) restrict(amp);

  extern "C" float opencl_sqrt(float x) restrict(amp);
  extern "C" double opencl_sqrt_double(double x) restrict(amp);

  extern "C" float opencl_tgamma(float x) restrict(amp);
  extern "C" double opencl_tgamma_double(double x) restrict(amp);

  extern "C" float opencl_tan(float x) restrict(amp);
  extern "C" double opencl_tan_double(double x) restrict(amp);

  extern "C" float opencl_tanh(float x) restrict(amp);
  extern "C" double opencl_tanh_double(double x) restrict(amp);

  extern "C" float opencl_tanpi(float x) restrict(amp);
  extern "C" double opencl_tanpi_double(double x) restrict(amp);

  extern "C" float opencl_trunc(float x) restrict(amp);
  extern "C" double opencl_trunc_double(double x) restrict(amp);
...
namespace fast_math {
  ...
  inline double atan2(double x, double y) restrict(amp,cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_atan2_double(x, y);
    #else
      return host_atan2(x, y);
    #endif
  }
  ...
  inline double copysign(double x, double y) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_copysign_double(x, y);
    #else
      return host_copysign(x, y);
    #endif
  }
  ...
  inline double fma(double x, double y, double z) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_fma_double(x, y , z);
    #else
      return host_fma(x, y , z);
    #endif
  }
  ...
  inline double hypot(double x, double y) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_hypot_double(x, y);
    #else
      return host_hypot(x, y);
    #endif
  }
  ...
  inline int isfinite(double x) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_isfinite_double(x);
    #else
      return host_isfinite(x);
    #endif
  }
  ...
  inline int isnormal(double x) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_isnormal_double(x);
    #else
      return host_isnormal(x);
    #endif
  }
  ...
  inline double ldexp(double x, int exp) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_ldexp_double(x,exp);
    #else
      return host_ldexp(x,exp);
    #endif
  }
  ...
  inline double nearbyint(double x) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_nearbyint_double(x);
    #else
      return host_nearbyint(x);
    #endif
  }
  ...
  inline double nextafter(double x, double y) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_nextafter_double(x, y);
    #else
      return host_nextafter(x, y);
    #endif
  }
  ...
  inline double rcbrt(double x) restrict(amp,cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return 1.0 / opencl_cbrt_double(x);
    #else
      return host_rcbrt(x);
    #endif
  }
  ...
  inline double remainder(double x, double y) restrict(amp,cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_remainder_double(x, y);
    #else
      return host_remainder(x, y);
    #endif
  }
  ...
  inline int signbit(double x) restrict(amp, cpu) {
    #if __KALMAR_ACCELERATOR__ == 1
      return opencl_signbit_double(x);
    #else
      return host_signbit(x);
    #endif
  }
