...
HC_MATH_WRAPPER_1(cospif, x)
HC_MATH_WRAPPER_FP_OVERLOAD_1(cospi, x)
...
HC_MATH_WRAPPER_1(rsqrtf, x)
HC_MATH_WRAPPER_FP_OVERLOAD_1(rsqrt, x)
...
HC_MATH_WRAPPER_1(sinpif, x)
HC_MATH_WRAPPER_FP_OVERLOAD_1(sinpi, x)
