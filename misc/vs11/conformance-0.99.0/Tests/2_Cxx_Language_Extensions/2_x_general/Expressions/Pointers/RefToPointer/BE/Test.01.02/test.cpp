...
{
	static void func(tiled_index<BLOCK_SIZE> idx, array_view<s1, 1> *&rpa1, array_view<s1, 1> *&rpa1f1, array_view<s1, 1> *&rpa2, array_view<s1, 1> *&rpa2f1, 
		array_view<s1, 1> *&rpa3, array_view<s1, 1> *&rpa3f1, array_view<int, 1> flag, int b1, int b2, int b3, int b4) __GPU_ONLY
    {
    ...
    vector<int> &flag, accelerator_view av)
{
    ...
    parallel_for_each(av, av1.extent.tile<BLOCK_SIZE>(), [=] (tiled_index<BLOCK_SIZE> idx) mutable __GPU_ONLY {

		array_view<s1> *p1 = b1 ? &av1f1 : &av1;
		array_view<s1> *p1f1 = &av1f1;

		array_view<s1> *p2 = b2 ? &av2 : &av2f1;
		array_view<s1> *p2f1 = &av2f1;

		array_view<s1> *p3 = b3 ? &av3 : &av3f1;
		array_view<s1> *p3f1 = &av3f1;
...
{
    srand(2010);
    accelerator_view av = require_device_with_double().default_view;;
