...
bool test_global(accelerator_view &alv)
{
    ...
    parallel_for_each(alv, av.extent, [=](index<RANK>idx) __GPU_ONLY 
    {
...
{
    accelerator_view alv = require_device_for<AMP_ELEMENT_TYPE>(device_flags::NOT_SPECIFIED, true).default_view;
