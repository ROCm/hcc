...
runall_result test_main()
{
    ...
    accelerator_view av =  require_device(Device::ALL_DEVICES).default_view;
    ...
    parallel_for_each(fA.extent.tile<YGroupSize, XGroupSize>(), [&](tiled_index<YGroupSize, XGroupSize> ti) __GPU_ONLY{
