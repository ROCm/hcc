...
namespace Concurrency {
    namespace Test {
		...
		private:
			...
			std::wstring _cerr_logfile_path;
			std::wstring _cout_logfile_path;

			std::map<std::wstring, std::wstring> _env_cache;
		...
		public:
			...
			const std::wstring& get_stderr_logfile_path() const;
			const std::wstring& get_stdout_logfile_path() const;
			...
			///</remarks>
			void set_stdout_logfile_path(const std::wstring& stdout_filename); 
			void set_stderr_logfile_path(const std::wstring& stderr_filename); 
			...
			int load_environment_variable_cache_from_file(const std::wstring& file_path);
