...
namespace details
{
    ...
    {
    public:
        static _T& _Project0(const array_view<_T,1>* _Arr_view, int _I) __GPU;
    };

    // Helper class for array projection
    template <typename _T, int _R>
    class _Array_projection_helper
    {
    public:
        static_assert(_R >= 2, "Rank must be greater or equal to 2");
        static array_view<const _T,_R-1> _Project0(const array<_T, _R>* _Array, int _I) __GPU;
        static array_view<_T,_R-1> _Project0(_In_ array<_T, _R>* _Array, int _I) __GPU;
    };
    ...
    {
    public:
        static const _T& _Project0(const array<_T,1>* _Array, int _I) __GPU;
        static _T& _Project0(_In_ array<_T,1>* _Array, int _I) __GPU;
    };
    ...
    struct _cmp_op_helper
    {
        static bool func(const _T & a, const _T & b) __GPU { static_assert(false, "invalid op"); return false;}
    };
    ...
    struct _compound_assign_op_helper
    {
        static void func(_T & a, const _T & b) __GPU { static_assert(false, "invalid op"); }
    };
    ...
    struct _arithmetic_op_helper
    {
        static void func(_T & a, const _T & b, const _T & c) __GPU { static_assert(false, "invalid op"); }
    };
...
#pragma warning( pop )
    ...
    {
        static void func(const void * _Tex_data, _Out_ void * _Val, const _T & _Index) __GPU_ONLY
        {
            __dp_read_texture(_Tex_data, _Val, static_cast<unsigned int>(_Index[0]), 1, 1);
        }
    };
    ...
    struct _Texture_read_helper<_T, 2>
    {
        static void func(const void * _Tex_data, _Out_ void * _Val, const _T & _Index) __GPU_ONLY
        {
            __dp_read_texture(_Tex_data, _Val, static_cast<unsigned int>(_Index[1]), static_cast<unsigned int>(_Index[0]), 1);
        }
    };
    ...
    struct _Texture_read_helper<_T, 3>
    {
        static void func(const void * _Tex_data, _Out_ void * _Val, const _T & _Index) __GPU_ONLY
        {
            __dp_read_texture(_Tex_data, _Val, static_cast<unsigned int>(_Index[2]), static_cast<unsigned int>(_Index[1]), static_cast<unsigned int>(_Index[0]));
        }
    };
    ...
    template <typename _Array_type>
    _Ubiquitous_buffer_ptr _Get_buffer(const _Array_type& _Array) __CPU_ONLY
    { 
    ...
    template <typename _Texture_type>
    _Texture_ptr _Get_texture(const _Texture_type& _Tex) __CPU_ONLY
    { 
...
//=============================================================================
void __dp_read_texture(const void *, _Out_ void *, unsigned int, unsigned int, unsigned int)  __GPU_ONLY;
