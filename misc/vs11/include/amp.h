...
protected:
    ...
    _Array_view_base(const _Array_view_base& _Other, const Concurrency::extent<_Rank>& _Array_extent) __GPU
        :
        _M_buffer_descriptor(_Other._M_buffer_descriptor),
        _Array_view_shape(_Other._Base_linear_offset(), _Array_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(const _Array_view_base& _Other, const Concurrency::index<_Rank>& _Section_origin, const Concurrency::extent<_Rank>& _Section_extent) __GPU
        :
        _M_buffer_descriptor(_Other._M_buffer_descriptor),
        _Array_view_shape(_Other, _Section_origin, _Section_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(const _Buffer_descriptor& _Buffer_desc, const Concurrency::extent<_Rank>& _Array_extent) __GPU
        :
        _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape(0,_Array_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(const _Buffer_descriptor& _Buffer_desc, int _Base_linear_offset, const Concurrency::extent<_Rank>& _Array_extent) __GPU
        :
        _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape(_Base_linear_offset,_Array_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(
        ...
        :
        _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape(_Base_linear_offset,_Array_extent,_View_offset,_View_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(const _Buffer_descriptor& _Buffer_desc, const Concurrency::extent<_Rank>& _Array_extent, 
        ...
        :
        _M_buffer_descriptor(_Buffer_desc),
        _Array_view_shape(0,_Array_extent,_Section_origin,_Section_extent)
    {
        // Register the view
        _Register();
    }
    ...
    _Array_view_base(_In_ void * _Data, const Concurrency::extent<_Rank>& _Array_extent) __GPU_ONLY
        :
        _Array_view_shape(0,_Array_extent), _M_buffer_descriptor(_Data, NULL, _Read_write_access, _Read_write_access)
    {
    }
    ...
    _Array_view_base(const void * _Data, const Concurrency::extent<_Rank>& _Array_extent) __GPU_ONLY
        :
        _Array_view_shape(0,_Array_extent), _M_buffer_descriptor(const_cast<void*>(_Data), NULL, _Read_access, _Read_access)
    {
    }
    ...
    _Array_view_base& operator=(const _Array_view_base &_Other) __GPU
    {
        if (this != &_Other)
        {
            ...
            _M_buffer_descriptor = _Other._M_buffer_descriptor;            
            _Array_view_shape::operator=(_Other);
    ...
    void _Project0(int _I, _Array_view_base<_Rank-1,_Element_size>& _Projected_view) const __GPU
    {
        ...
        _Array_view_shape::_Project0(_I, _Projected_view);
    ...
    _View_shape_ptr _Create_buffer_view_shape() const __CPU_ONLY
    {
        unsigned int bufElemSize = static_cast<unsigned int>(_M_buffer_descriptor._Get_buffer_ptr()->_Get_master_buffer()->_Get_elem_size());
...
private:
    ...
    {
        _View_shape_ptr _Base_shape = _Get_buffer_view_shape(_Descriptor);
                                              ...
                                              const Concurrency::index<_Rank>& _Section_origin, const Concurrency::extent<_Rank>& _Section_extent) __CPU_ONLY
    {
        ...
        while (_I < _Base_shape->_Get_rank())
        {
            ...
            else 
            {
                ...
                if (_J == (_Rank - 1)) 
                {
                    unsigned int bufElemSize = static_cast<unsigned int>(_Descriptor._Get_buffer_ptr()->_Get_master_buffer()->_Get_elem_size());
                    unsigned int elemSize = _Element_size * sizeof(int);
...
public:
    ...
    /// </returns>
    auto operator[] (int _I) const __GPU 
        -> decltype(details::_Array_view_projection_helper<_Value_type,_Rank>::_Project0((array_view<_Value_type,_Rank> *)NULL, _I))
    {
    ...
    {
        return _Convert<_Value_type2>(_Reinterpret_as<sizeof(_Value_type2)/sizeof(int)>());
    }
    ...
    concurrency::completion_future synchronize_async() const __CPU_ONLY
    {
        ...
        _Buffer_ptr _PBuf;
        _Event _Ev = _Get_access_async(_M_buffer_descriptor._Get_view_key(), _M_buffer_descriptor._Get_buffer_ptr()->_Get_master_accelerator_view(), _Read_access, _PBuf);
...
class array_view<const _Value_type, _Rank> : public _Array_view_base<_Rank,sizeof(_Value_type)/sizeof(int)>
{
    ...
    friend class details::_Array_view_projection_helper<const _Value_type,_Rank>;
    friend class details::_Array_view_projection_helper<const _Value_type,_Rank+1>;
...
public:
    ...
    template <typename _Container> array_view(const Concurrency::extent<_Rank>& _Extent, const _Container& _Src) __CPU_ONLY
        :_Base(_Src.data(),_Extent)
    {
        static_assert( std::is_same<std::remove_const<std::remove_reference<decltype(*_Src.data())>::type>::type, _Value_type>::value, "container element type and array view element type must match");
        _Initialize(_Src.size());
    }
    ...
    /// </returns>
    auto operator[] (int _I) const __GPU 
        -> decltype(details::_Array_view_projection_helper<const _Value_type,_Rank>::_Project0((array_view<const _Value_type,_Rank> *)NULL, _I))
    {
        return details::_Array_view_projection_helper<const _Value_type,_Rank>::_Project0(this, _I);
    }
...
private:
    ...
    array_view(const array_view& _Other, const Concurrency::index<_Rank>& _Section_origin, const Concurrency::extent<_Rank>& _Section_extent) __GPU
        :
        _Array_view_base(_Other, _Section_origin, _Section_extent)
    {
        _Initialize();
    }
...
/// <summary>
///     An array is a multi-dimenstional data aggregate on a accelerator_view.
/// </summary>
/// <param name="_Rank">
...
template <typename _Value_type, int _Rank = 1> class array
{
    ...
    friend _Ubiquitous_buffer_ptr details::_Get_buffer<array<_Value_type,_Rank>>(const array<_Value_type,_Rank>& _Array) __CPU_ONLY;
    ...
    explicit array(const Concurrency::extent<_Rank> & _Extent) __CPU_ONLY
        : _M_extent(_Extent)
    {                        
        _Initialize(details::_Select_default_accelerator().default_view);
    }
    ...
    /// </param>
    array(const Concurrency::extent<_Rank>& _Extent, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(_Extent)
    {                        
        _Initialize(_Av);
    }
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    array(int _E0, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0))
    {                        
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    array(int _E0, int _E1, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1))
    {                        
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    array(int _E0, int _E1, int _E2, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2))
    {                        
    ...
    template <typename _InputIterator> array(const Concurrency::extent<_Rank>& _Extent, _InputIterator _Src_first, _InputIterator _Src_last) __CPU_ONLY
        : _M_extent(_Extent)
    {
        _Initialize(details::_Select_default_accelerator().default_view, _Src_first, _Src_last);
    }
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(const Concurrency::extent<_Rank>& _Extent, _InputIterator _Src_first, _InputIterator _Src_last, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(_Extent)
    {
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(const Concurrency::extent<_Rank>& _Extent, _InputIterator _Src_first, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(_Extent)
    {
        _InputIterator _Src_last = _Src_first;
        std::advance(_Src_last, this->extent.size());
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, _InputIterator _Src_first, _InputIterator _Src_last, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0))
    {
        static_assert(_Rank == 1, "array(int, iterator, iterator) is only permissible on array<T, 1>");
        _Initialize(_Av, _Src_first, _Src_last);
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, _InputIterator _Src_first, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0))
    {
        static_assert(_Rank == 1, "array(int, iterator) is only permissible on array<T, 1>");
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, int _E1, _InputIterator _Src_first, _InputIterator _Src_last, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1))
    {
        static_assert(_Rank == 2, "array(int, int, iterator, iterator) is only permissible on array<T, 2>");
        _Initialize(_Av, _Src_first, _Src_last);
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, int _E1, _InputIterator _Src_first, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1))
    {
        static_assert(_Rank == 2, "array(int, int, iterator) is only permissible on array<T, 2>");
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, int _E1, int _E2, _InputIterator _Src_first, _InputIterator _Src_last, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2))
    {
        static_assert(_Rank == 3, "array(int, int, int, iterator, iterator) is only permissible on array<T, 3>");
        _Initialize(_Av, _Src_first, _Src_last);
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    template <typename _InputIterator> array(int _E0, int _E1, int _E2, _InputIterator _Src_first, Concurrency::accelerator_view _Av) __CPU_ONLY
        : _M_extent(Concurrency::extent<_Rank>(_E0, _E1, _E2))
    {
        static_assert(_Rank == 3, "array(int, int, int, iterator) is only permissible on array<T, 3>");
    ...
    ///   An accelerator_view where this array resides.
    /// </param>
    array(const array_view<const _Value_type,_Rank>& _Src, accelerator_view _Av) __CPU_ONLY
        :_M_extent(_Src.extent)
    {
        _Initialize(_Av);
        Concurrency::copy(_Src,*this);
...
#pragma warning( disable : 4880 )
        // Casting away constness in direct3d restricted scope might result in 
...
#pragma warning( pop ) 
    ...
    ///     The element at index component _I, or an array_view projected on the most-significant dimension.
    /// </returns>
    auto operator[](int _I)  __GPU 
        -> decltype(details::_Array_projection_helper<_Value_type,_Rank>::_Project0((array<_Value_type,_Rank> *)NULL,_I))
    { 
    ...
    /// </returns>
    auto operator[](int _I)  const __GPU 
        -> decltype(details::_Array_projection_helper<_Value_type,_Rank>::_Project0((const array<_Value_type,_Rank> *)NULL,_I))
    { 
        return details::_Array_projection_helper<_Value_type,_Rank>::_Project0(this,_I);
    }
    ...
    {
        return array_view<_Value_type,1>(_M_buffer_descriptor, Concurrency::extent<1>(extent.size())).reinterpret_as<_Value_type2>();
    }
...
#pragma warning( pop )
    ...
    ~array() __CPU_ONLY
    {
        // Destructor should not throw because it may be called when already processing
...
private:
    ...
    array(const Concurrency::extent<_Rank>& _Extent, const Concurrency::accelerator_view &_Av, _Buffer_descriptor _Buffer_descriptor)
    ...
    void _Initialize(Concurrency::accelerator_view _Av) __CPU_ONLY
    {
        ...
        _Buffer_ptr _PBuf = _Buffer::_Create_buffer(_Av, totalExtent, sizeof(_Value_type));
    ...
    void _Initialize(Concurrency::accelerator_view _Av, _InputIterator _Src_first, _InputIterator _Src_last) __CPU_ONLY
    {
        _Initialize(_Av);
    ...
    void _Initialize(Concurrency::accelerator_view _Av, Concurrency::accelerator_view _Associated_Av) __CPU_ONLY
    {
        ...
        if (_Av.accelerator == accelerator(accelerator::cpu_accelerator)) {
            _PBuf = _Buffer::_Create_stage_buffer(_Associated_Av, _Av, totalExtent, sizeof(_Value_type));
            _PBuf->_Map_stage_buffer(_Write_access, true);
            _M_buffer_descriptor._Set_buffer_ptr(_Ubiquitous_buffer::_Create_ubiquitous_buffer(_PBuf));
        }
        else {
            _PBuf = _Buffer::_Create_buffer(_Av, totalExtent, sizeof(_Value_type));
            _M_buffer_descriptor._Set_buffer_ptr(_Ubiquitous_buffer::_Create_ubiquitous_buffer(_PBuf));
        }
    ...
    void _Register() __CPU_ONLY
    {
        Concurrency::accelerator_view cpuAv = _Has_cpu_access() ? this->accelerator_view : accelerator(accelerator::cpu_accelerator).default_view;
    ...
    _Ubiquitous_buffer_ptr _Get_buffer() __CPU_ONLY const
    {
        return _M_buffer_descriptor._Get_buffer_ptr(); 
    }

    _Event _Get_access_async(_Access_mode _Mode, _Buffer_ptr &_Buf_ptr) __CPU_ONLY const
    {
        _Buffer_ptr _PBuf;
        _Event _Ev = details::_Get_access_async(_M_buffer_descriptor._Get_view_key(), accelerator_view, _Mode, _PBuf);
        _Buf_ptr = _PBuf;
    ...
    _View_shape_ptr _Create_buffer_view_shape() const
    {
        _ASSERTE(_Get_buffer()->_Get_master_buffer()->_Get_elem_size() == sizeof(_Value_type));

        unsigned int _ZeroOffset[_Rank] = {0};
        return _View_shape::_Create_view_shape(static_cast<unsigned int>(_Rank), 0, reinterpret_cast<const unsigned int*>(&this->extent[0]),
                                               reinterpret_cast<const unsigned int*>(&_ZeroOffset), reinterpret_cast<const unsigned int*>(&this->extent[0]));
    }

    bool _Has_cpu_access() const __CPU_ONLY
    {
        return (accelerator_view.accelerator == accelerator(accelerator::cpu_accelerator));
    }
    ...
    void _Refresh_data_ptr(_Access_mode _Requested_mode, bool _Exception = true) __CPU_ONLY
    {
        ...
        if ((_M_buffer_descriptor._M_curr_cpu_access_mode & _Requested_mode) != _Requested_mode) {
            if (_Has_cpu_access()) {
                auto _Span_id = details::_Get_amp_trace()->_Start_array_view_synchronize_event_helper(_M_buffer_descriptor);
                _Buffer_ptr _PBuf;
                this->_Get_access_async(_Requested_mode, _PBuf)._Get();
                details::_Get_amp_trace()->_Write_end_event(_Span_id);
            }
            else {
                if (_Exception) {
...
_Event _Copy_async_impl(const array<_Value_type, _Rank>& _Src, const array_view<_Value_type, _Rank>& _Dest)
{
    ...
    _Event _Ev = _Get_access_async(_Src, _Read_access, _PSrcBuf);
    _Ev = _Ev._Add_event(_Get_access_async(_DestBufDesc._Get_view_key(), _DestBufDesc._Get_buffer_ptr()->_Get_master_accelerator_view(), _Write_access, _PDestBuf));
...
_Event _Copy_async_impl(const array_view<const _Value_type, _Rank>& _Src, array<_Value_type, _Rank>& _Dest)
{
    ...
    accelerator_view _Dest_accelerator_view = _DestBufDesc._Get_buffer_ptr()->_Get_master_accelerator_view();
    accelerator_view _Src_accelerator_view = _Select_copy_src_accelerator_view(_SrcBufDesc._Get_view_key(), _Dest_accelerator_view);

    _Buffer_ptr _PSrcBuf, _PDestBuf;
    _Event _Ev = _Get_access_async(_SrcBufDesc._Get_view_key(), _Src_accelerator_view, _Read_access, _PSrcBuf);
...
_Event _Copy_async_impl(const array_view<const _Value_type, _Rank>& _Src, const array_view<_Value_type, _Rank>& _Dest)
{
    ...
    _Buffer_ptr _PSrcBuf, _PDestBuf;
    _Event _Ev = _Get_access_async(_SrcBufDesc._Get_view_key(), _Src_accelerator_view, _Read_access, _PSrcBuf);
    _Ev = _Ev._Add_event(_Get_access_async(_DestBufDesc._Get_view_key(), _Dest_accelerator_view, _Write_access, _PDestBuf));
    return _Ev._Add_continuation(std::function<_Event()>([_PSrcBuf, _PSrcShape, _PDestBuf, _PDestShape]() mutable -> _Event {
        return details::_Copy_impl(_PSrcBuf, _PSrcShape, _PDestBuf, _PDestShape);
    }));
}
...
{    
    ...
    _Buffer_ptr _PDestBuf;
    _Event _Ev = _Get_access_async(_DestBufDesc._Get_view_key(), _Dest_accelerator_view, _Dest_access_mode, _PDestBuf);
...
_Event _Copy_async_impl(const array_view<_Value_type, _Rank> &_Src, OutputIterator _DestIter)
{
    ...
    accelerator_view _Dest_accelerator_view = accelerator(accelerator::cpu_accelerator).default_view;
    accelerator_view _Src_accelerator_view = _Select_copy_src_accelerator_view(_SrcBufDesc._Get_view_key(), _Dest_accelerator_view);
...
namespace direct3d 
{
    ...
    {
        return details::_D3D_interop::_Get_D3D_buffer(_Get_buffer(_Array)->_Get_master_buffer());
    }
    ...
    template<typename _Value_type, int _Rank> array<_Value_type, _Rank> make_array(const Concurrency::extent<_Rank> &_Extent, const Concurrency::accelerator_view &_Av, _In_ IUnknown *_D3D_buffer) __CPU_ONLY
    {
        ...
        return array<_Value_type, _Rank>(_Extent, _Av, _Buffer_descriptor(_PBuf->_Get_master_buffer()->_Get_host_ptr(), _PBuf, _Is_array_mode, _Read_write_access));
    }
...
/// <summary>
///     Peforms an atomic addition of _Value to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
...
/// <summary>
///     Peforms an atomic subtraction of _Value from the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
/// <summary>
///     Peforms an atomic increment to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
/// <summary>
///     Peforms an atomic decrement to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
/// <summary>
///     Peforms an atomic bitwise and operation of _Value to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
/// <summary>
///     Peforms an atomic bitwise or operation of _Value to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
/// <summary>
///     Peforms an atomic bitwise xor operation of _Value to the memory location pointed to by _Dest
/// </summary>
/// <param name="_Dest">
///     Pointer to the destination location
/// </param>
...
{
    _Host_Scheduling_info _SchedulingInfo = {details::_Get_accelerator_view_impl_ptr(_Accl_view)};
    details::_Parallel_for_each(&_SchedulingInfo, _Compute_domain, _Kernel);
}
