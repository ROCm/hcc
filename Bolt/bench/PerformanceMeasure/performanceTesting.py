...
class TestCombination:
    def __init__(self,
                 lengthx, device, precision, label):
        self.x = lengthx
        self.device = device
    ...
    def __str__(self):
        return self.x + ':' + self.device + ', ' + self.precision + ' -- ' + self.label

class GraphPoint:
    def __init__(self,
                 lengthx, device, precision, label, gflops):
        self.x = lengthx
        self.device = device
        self.precision = precision
        self.label = label
    ...
    def __str__(self):
        ...
        return self.x + ':' + self.device + ' -- ' + self.label + '; ' + self.gflops
