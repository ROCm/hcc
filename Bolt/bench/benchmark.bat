...
python plotPerformance.py --y_axis_label "GBytes/sec" --title "Sort Performance" --x_axis_scale log2 -d sort_bolt_device.txt -d sort_bolt_host.txt -d sort_tbb_host.txt --outputfile sortPerformance.pdf
...
python plotPerformance.py --y_axis_label "GBytes/sec" --title "Stable Sort Performance" --x_axis_scale log2 -d stablesort_bolt_device.txt -d stablesort_bolt_host.txt -d stablesort_tbb_host.txt --outputfile stablesortPerformance.pdf
...
python plotPerformance.py --y_axis_label "GBytes/sec" --title "Inclusive Scan Performance" --x_axis_scale log2 -d inclusivescan_bolt_device.txt -d inclusivescan_bolt_host.txt -d inclusivescan_tbb_host.txt --outputfile inclusivescanPerformance.pdf