...
#pragma once
#if !defined( BOLT_AMP_STABLESORT_BY_KEY_H )
#define BOLT_AMP_STABLESORT_BY_KEY_H
...
namespace amp {
    ...
    */ 
    ...
    /*! \addtogroup AMP-stable_sort_by_key
    *   \ingroup sorting
    *   \{
    */
    ...
    */
    template< typename RandomAccessIterator1, typename RandomAccessIterator2 >
    void stable_sort_by_key( bolt::amp::control &ctl, RandomAccessIterator1 keys_first, RandomAccessIterator1 keys_last, 
        RandomAccessIterator2 values_first);
