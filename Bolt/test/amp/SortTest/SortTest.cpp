...
TYPED_TEST_P( SortArrayTest, GreaterFunction )
{
    ...
    bolt::BKND::SORT_FUNC( SortArrayTest< gtest_TypeParam_ >::boltInput.begin( ), SortArrayTest< gtest_TypeParam_ >::boltInput.end( ), bolt::BKND::greater< ArrayType >( ) );
    ...
    else
    {
        ...
        bolt::BKND::SORT_FUNC( SortArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin( ) + startIndex, SortArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin( ) + endIndex, bolt::BKND::greater< ArrayType >( )  );
...
TYPED_TEST_P( SortArrayTest, LessFunction )
{
    ...
    bolt::BKND::SORT_FUNC( SortArrayTest< gtest_TypeParam_ >::boltInput.begin( ), SortArrayTest< gtest_TypeParam_ >::boltInput.end( ), bolt::BKND::less<ArrayType>() );
    ...
    else
    {
        ...
        bolt::BKND::SORT_FUNC( SortArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin( ) + startIndex, SortArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin( ) + endIndex, bolt::BKND::less< ArrayType >( )  );
