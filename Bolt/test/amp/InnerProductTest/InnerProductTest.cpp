...
void testDeviceVector()
{
    ...
    bolt::amp::device_vector<int> dB(hB.begin(),hB.end()); 
    
    int hSum = std::inner_product(hA.begin(), hA.end(), hB.begin(), 1);

    int sum = bolt::amp::inner_product(  dA.begin(), dA.end(),
                                        dB.begin(), 1, bolt::amp::plus<int>(), bolt::amp::multiplies<int>()  );
};
...
TYPED_TEST_P( InnerProductArrayTest, Normal )
{
    ...
    ArrayType boltInnerProduct = bolt::amp::inner_product(  InnerProductArrayTest< gtest_TypeParam_ >::boltInput.begin( ), InnerProductArrayTest< gtest_TypeParam_ >::boltInput.end( ), InnerProductArrayTest< gtest_TypeParam_ >::boltInput2.begin( ),init,
                                                        bolt::amp::plus<ArrayType>(),bolt::amp::multiplies<ArrayType>());
...
TYPED_TEST_P( InnerProductArrayTest, GPU_DeviceMultipliesFunction )
{
    ...
    ArrayType boltInnerProduct = bolt::amp::inner_product( c_gpu, InnerProductArrayTest< gtest_TypeParam_ >::boltInput.begin( ), InnerProductArrayTest< gtest_TypeParam_ >::boltInput.end( ), InnerProductArrayTest< gtest_TypeParam_ >::boltInput2.begin(), 
                                                init, bolt::amp::plus<ArrayType>(), bolt::amp::multiplies<ArrayType>());
...
REGISTER_TYPED_TEST_CASE_P( InnerProductArrayTest, Normal, GPU_DeviceNormal, MultipliesFunction, GPU_DeviceMultipliesFunction);
...
TEST( InnerProductStdVectWithInit, withIntWdInitWithStdPlusMinus)
{
    ...
    int boltInnerProduct= bolt::amp::inner_product( boltInput.begin( ), boltInput.end( ), boltInput2.begin(), 
                                                   init, bolt::amp::plus<int>(), bolt::amp::minus<int>());
...
TEST( CPUInnerProductStdVectWithInit, withIntWdInitWithStdPlusMinus)
{
    ...
    int stlInnerProduct = std::inner_product(stdInput.begin(),stdInput.end(), stdInput2.begin(),init, std::plus<int>(), 
                                             std::minus<int>() );
    int boltInnerProduct= bolt::amp::inner_product(ctl, boltInput.begin( ), boltInput.end( ), boltInput2.begin(), 
                                                  init, bolt::amp::plus<int>(), bolt::amp::minus<int>());
...
TEST_P (InnerProductTestMultFloat, multiplyWithFloats)
{
    ...
    float boltInnerProduct = bolt::amp::inner_product(myBoltArray, myBoltArray + arraySize, myBoltArray2,
                                                     1.0f, bolt::amp::multiplies<float>(), bolt::amp::plus<float>());
...
TEST_P (InnerProductTestMultFloat, CPUmultiplyWithFloats)
{
    ...
    float stlInnerProduct = std::inner_product(  myArray,
                                                 ...
                                                 myArray2,
                                                 1.0f, std::multiplies<float>(), std::plus<float>()  );
    float boltInnerProduct = bolt::amp::inner_product(ctl, myBoltArray, myBoltArray + arraySize, myBoltArray2,
                                                     1.0f, bolt::amp::multiplies<float>(), bolt::amp::plus<float>());
...
TEST_P( InnerProductTestMultFloat, serialFloatValuesWdControl )
{
    ...
    float boltInnerProduct = bolt::amp::inner_product(ctl.getDefault(), boltVect.begin(), boltVect.end(),
...
TEST_P( InnerProductTestMultFloat, CPUFloatValuesWdControl )
{
    ...
    float stdInnerProductValue = std::inner_product(A.begin(), A.end(), B.begin(), init );
    float boltInnerProduct = bolt::amp::inner_product(ctl, boltVect.begin(), boltVect.end(), boltVect2.begin(), init );
...
TEST_P (InnerProductTestMultDouble, multiplyWithDouble)
{
    ...
    double boltInnerProduct = bolt::amp::inner_product(myBoltArray, myBoltArray + arraySize, myBoltArray2, 1.0, 
                                                      bolt::amp::multiplies<double>(), bolt::amp::plus<double>());
...
TEST_P (InnerProductTestMultDouble, CPUmultiplyWithDouble)
{
    ...
    double boltInnerProduct = bolt::amp::inner_product(ctl, myBoltArray, myBoltArray + arraySize, myBoltArray2, 1.0,
                                                      bolt::amp::multiplies<double>(), bolt::amp::plus<double>());
...
struct UDD
{
    ...
    UDD operator + (const UDD &rhs) const restrict(cpu, amp) 
    {
      UDD _result;
      _result.a = a + rhs.a;
      _result.b = b + rhs.b;
...
TEST( InnerProductUDD , UDDPlusOperatorInts )
{
    ...
    bolt::amp::device_vector< UDD >input( refInput.begin(), refInput.end() );
    bolt::amp::device_vector< UDD >input2( refInput2.begin(), refInput2.end() );
    ...
    UDD boltInnerProduct = bolt::amp::inner_product( input.begin(), input.end(), input2.begin(),
                                                    UDDzero, plusOp , mulOp);
...
TEST( InnerProductUDD , Serial_UDDPlusOperatorInts )
{
    //setup containers
    int length = 1024;
    std::vector< UDD > refInput( length );
    ...
    UDD stdInnerProduct =  std::inner_product( refInput.begin(), refInput.end(), refInput2.begin(), 
                                               UDDzero, plusOp, mulOp );
    UDD boltInnerProduct = bolt::amp::inner_product( ctl, input.begin(), input.end(), input2.begin(),
                                                    UDDzero, plusOp , mulOp);
...
TEST( InnerProductOffset , DeviceVectorOffset )
{
    ...
    bolt::amp::device_vector< int >input2( refInput2.begin(), refInput2.end() );

    int stdInnerProduct =  std::inner_product( refInput.begin() + 10, refInput.end(), refInput2.begin() + 10, 
                                               0, std::plus<int>(), std::multiplies<int>() );
    int boltInnerProduct = bolt::amp::inner_product( input.begin() + 10, input.end(), input2.begin() + 10,
                                                    0, bolt::amp::plus<int>() , bolt::amp::multiplies<int>() );
...
TEST( InnerProductOffset , HostVectorOffset )
{
    ...
    int stdInnerProduct =  std::inner_product( refInput.begin() + 60, refInput.end(), refInput2.begin() + 60, 
                                               0, std::plus<int>(), std::multiplies<int>() );
    int boltInnerProduct = bolt::amp::inner_product( refInput.begin() + 60, refInput.end(), refInput2.begin() + 60,
                                                    0, bolt::amp::plus<int>() , bolt::amp::multiplies<int>() );
...
TEST( InnerProductOffset , DeviceVectorOffsetSerialCpu )
{
    ...
    int stdInnerProduct =  std::inner_product( refInput.begin() + 10, refInput.end(), refInput2.begin() + 10, 
                                               0, std::plus<int>(), std::multiplies<int>() );
    int boltInnerProduct = bolt::amp::inner_product( ctl, input.begin() + 10, input.end(), input2.begin() + 10,
                                                    0, bolt::amp::plus<int>() , bolt::amp::multiplies<int>() );
...
#if defined( ENABLE_TBB )
TEST( InnerProductOffset , DeviceVectorOffsetMultiCoreCpu )
{
    //setup containers
    int length = 1024;
    std::vector< int > refInput( length );
...
TEST( InnerProductOffset , HostVectorOffsetSerialCpu )
{
    ...
    int stdInnerProduct =  std::inner_product( refInput.begin() + 60, refInput.end(), refInput2.begin() + 60, 
                                               0, std::plus<int>(), std::multiplies<int>() );
    int boltInnerProduct = bolt::amp::inner_product( ctl, refInput.begin() + 60, refInput.end(), refInput2.begin() + 60,
                                                    0, bolt::amp::plus<int>() , bolt::amp::multiplies<int>() );
...
#if defined( ENABLE_TBB )
TEST( InnerProductOffset , HostVectorOffsetMultiCoreCpu )
{
    //setup containers
    int length = 1024;
    std::vector< int > refInput( length );
...
void simpleInProd1(int aSize)
{
    ...
    int boltInProd = bolt::amp::inner_product(A.begin(), A.end(), B.begin(),0, bolt::amp::plus<int>(),
...
void floatInProd1(int aSize)
{
    ...
    float boltInProd = bolt::amp::inner_product(A.begin(), A.end(), B.begin(), x);
...
void InProdDV()
{
    ...
    int sum = bolt::amp::inner_product(dA.begin(), dA.end(), dB.begin(), 1,bolt::amp::plus<int>(),
                                      bolt::amp::multiplies<int>());
