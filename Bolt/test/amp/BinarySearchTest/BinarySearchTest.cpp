...
#else
#define TEST_MULTICORE_TBB_SEARCH 0
#endif
...
// UDD that Adds all four double elements and returns true if lhs_sum > rhs_sum

struct AddD4
{
    bool operator()(const uddtD4 &lhs, const uddtD4 &rhs) const restrict(cpu, amp)
    {
...
TEST(MultiCoreCPU, MultiCoreAddDouble4)
{
    ...
    // perform search
    stdresult = std::binary_search(refInput.begin(), refInput.end(), std_val);
    boltresult = bolt::amp::binary_search(ctl, input.begin(), input.end(), val);
...
{
    int length = 1025;
    bolt::amp::device_vector< float > boltInput(  length, 0.0, true  );
...
TYPED_TEST_P( BSearchArrayTest, GreaterFunction )
{
    ...
    bolt::amp::sort(BSearchArrayTest< gtest_TypeParam_ >::bolt_source.begin(), BSearchArrayTest< gtest_TypeParam_ >::bolt_source.end(),
      bolt::amp::greater< ArrayType >());
    ...
    boltresult = bolt::BKND::SEARCH_FUNC( BSearchArrayTest< gtest_TypeParam_ >::bolt_source.begin( ), BSearchArrayTest< gtest_TypeParam_ >::bolt_source.end( ),
      BSearchArrayTest< gtest_TypeParam_ >::val, bolt::amp::greater< ArrayType >( ) );
    ...
    else
    {
        ...
        bolt::amp::sort(BSearchArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin(), BSearchArrayTest< gtest_TypeParam_ >::boltOffsetIn.end(), bolt::amp::greater< ArrayType >());
...
TYPED_TEST_P( BSearchArrayTest, LessFunction )
{
    ...
    bolt::amp::sort(BSearchArrayTest< gtest_TypeParam_ >::bolt_source.begin(), BSearchArrayTest< gtest_TypeParam_ >::bolt_source.end(), bolt::amp::less< ArrayType >());

    //  Calling the actual functions under test
    stdresult = std::SEARCH_FUNC( BSearchArrayTest< gtest_TypeParam_ >::std_source.begin( ), BSearchArrayTest< gtest_TypeParam_ >::std_source.end( ), 
      BSearchArrayTest< gtest_TypeParam_ >::std_val, std::less< ArrayType >() ); 
    boltresult = bolt::BKND::SEARCH_FUNC( BSearchArrayTest< gtest_TypeParam_ >::bolt_source.begin( ), BSearchArrayTest< gtest_TypeParam_ >::bolt_source.end( ), 
      BSearchArrayTest< gtest_TypeParam_ >::val, bolt::amp::less< ArrayType >( ) );
    ...
    else
    {
        ...
        bolt::amp::sort(BSearchArrayTest< gtest_TypeParam_ >::boltOffsetIn.begin(), BSearchArrayTest< gtest_TypeParam_ >::boltOffsetIn.end(), bolt::amp::less< ArrayType >());
...
REGISTER_TYPED_TEST_CASE_P( BSearchArrayTest, Normal, 
                                           GreaterFunction, 
                                           LessFunction);
...
protected:
    ...
    bolt::amp::device_vector< float > boltInput, boltOffsetIn;
};
...
protected:
    ...
    bolt::amp::device_vector< double > boltInput, boltOffsetIn;
};
#endif
...
struct UDD { 
    ...
    void operator = (const UDD& other)  restrict(cpu, amp) { 
        a = other.a;
        b = other.b;
    }
    ...
    struct BSearchBy_UDD_b {
        bool operator() (UDD& a, UDD& b)   restrict(cpu, amp)
        { 
            return (a.b>b.b); 
        };
    };
...
protected:
    ...
    bolt::amp::device_vector< UDD > boltInput,boltOffsetIn;
};
...
TEST_P( BSearchIntegerVector, Greater )
{
    ...
    bolt::amp::sort( boltInput.begin( ), boltInput.end( ), bolt::amp::greater< int >());

    //  Calling the actual functions under test
    stdresult = std::SEARCH_FUNC( stdInput.begin( ), stdInput.end( ), val, std::greater< int >() );
    boltresult = bolt::BKND::SEARCH_FUNC( boltInput.begin( ), boltInput.end( ), val, bolt::amp::greater< int >());
...
TEST_P( BSearchIntegerVector, SerialGreater )
{
    ...
    std::sort( stdInput.begin( ), stdInput.end( ), std::greater< int >() );
    bolt::amp::sort( ctl, boltInput.begin( ), boltInput.end( ), bolt::amp::greater< int >());

    //  Calling the actual functions under test
    stdresult = std::SEARCH_FUNC( stdInput.begin( ), stdInput.end( ), val, std::greater< int >() );
    boltresult = bolt::BKND::SEARCH_FUNC( ctl, boltInput.begin( ), boltInput.end( ), val, bolt::amp::greater< int >());
...
TEST_P( BSearchFloatDeviceVector, SerialNormal )
{
    ...
    boltresult = bolt::BKND::SEARCH_FUNC(ctl, boltInput.begin( ), boltInput.end( ), val, bolt::amp::less< valtype >( ) );
    ...
    {
        stdresult = std::SEARCH_FUNC( stdOffsetIn.begin( ) + startIndex, stdOffsetIn.begin( ) + endIndex, val, std::less< valtype >() );
        boltresult = bolt::BKND::SEARCH_FUNC( ctl, boltOffsetIn.begin( ) + startIndex, boltOffsetIn.begin( ) + endIndex, val, bolt::amp::less< valtype >( ) );
...
TEST (rawArrayTest, floatarray){
	...
	bolt::BKND::sort( boltArray, boltArray+sizeOfInputBufer, bolt::amp::greater<float>( ) );
	...
	for (int i = 0 ; i < sizeOfInputBufer; i++)
    {
        ...
        myresult = bolt::BKND::SEARCH_FUNC( boltArray, boltArray+sizeOfInputBufer, my_val, bolt::amp::greater<float>( ) );
	...
	bolt::BKND::sort( boltArray+17, boltArray+sizeOfInputBufer-129, bolt::amp::greater<float>( ) );
	...
	for (int i = 0 ; i < sizeOfInputBufer; i++)
    {
        ...
        myresult = bolt::BKND::SEARCH_FUNC( boltArray+17, boltArray+sizeOfInputBufer-129, my_val, bolt::amp::greater<float>( ) );
